...
public class GUI extends JFrame {
    ...
    public GUI() {
        ...
        this.OnomaArxieou.setBounds(180, 200, 150, 20);
        ...
        this.Destination.setBounds(10, 250, 170, 20);
        this.OnomaEksagogis = new JTextField();
        this.OnomaEksagogis.setBounds(200, 250, 150, 20);
        this.exit = new JButton("Exit");
        this.exit.setBounds(300, 300, 65, 30);
        this.Apotelesma = new JButton("Compare Files");
        this.Apotelesma.setBounds(15, 300, 160, 20);
